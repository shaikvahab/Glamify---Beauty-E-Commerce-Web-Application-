      ...
      <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center">
        ...
        <div className="w-full md:w-1/2 px-12">
          ...
          <div className="mt-10 flex gap-4">
            <button className="px-6 py-2 bg-white text-gray-700 border border-gray-300 rounded-md hover:bg-gray-100 transition duration-300">
              Add to Cart
            </button>
            <button className="px-6 py-2 bg-[#253068] text-white rounded-md hover:bg-[#1f2a4a] transition duration-300"
            onClick={handleClick}
            >
              Buy Now
            </button>
